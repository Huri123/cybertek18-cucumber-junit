...
//basinda @db olanlari calistiracak
...
public class Hooks {
    ...
    public void tearDownScenario(Scenario scenario) {
        ...
        //scenario.getName().soutv
        System.out.println("scenario.getName() = " + scenario.getName());
        //scenario.getSourceTagNames().soutv
        System.out.println("scenario.getSourceTagNames() = " + scenario.getSourceTagNames());
        //scenario.isFailed().soutv
        ...
        //Driver.getDriver().getScreenshotAs(); //boyle yapinca getirmiyor. Casting yapmamiz lazim
        //(TakesScreenshot) Driver.getDriver().getScreenshotAs(); //boyle yapinca da getirmiyor.ekstra paranteze alman lazim.((TakesScreenshot) Driver.getDriver())

        if(scenario.isFailed()) {
            byte[] screenshot = ((TakesScreenshot) Driver.getDriver()).getScreenshotAs(OutputType.BYTES);

            scenario.attach(screenshot, "image/png", scenario.getName()); //is attaching screenshot to our report.
            //Target in altindaki cucumber report right click+open browser da screenshot i gorebilirsin tabi scenario fail ise
        }
    }
