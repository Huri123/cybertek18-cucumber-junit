...
public class GoogleStepDefinitions {
    ...
    public void user_should_see_title_is_google() {
        ...
        //Only difference (between Asssert in TestNG and junit) is that we put the message before expected and actual?
        ...
        //Assert bu testNG den degil junit den geliyor.Cunku suan burda testNG degil junit kullaniyoruz. daha oncekiler testNG den geliyordu.
    ...
    public void userSearches(String searchValue) {  //(String arg0) boyleydi (String searchValue) boyle yaptik
